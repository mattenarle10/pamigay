...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  Widget _buildProfileHeader() {
    String profileImageUrl = '';
    if (widget.userData != null && widget.userData!['profile_image'] != null && widget.userData!['profile_image'].isNotEmpty) {
      profileImageUrl = _userService.getProfileImageUrl(widget.userData!['profile_image']);
      print('Profile image URL in edit screen: $profileImageUrl');
    }
